using Dapper;
using PersonalSecretaryApi.Context;
using PersonalSecretaryApi.Contracts;
using PersonalSecretaryApi.Dto;
using PersonalSecretaryApi.Entities;
using System;
...
namespace PersonalSecretaryApi.Repository
{
